...
public class CoastalFinancialLinkTests
{
    ...
    private const string ExpectedBaselineSha256 = "086bee8097d972552d5d3452be181db5106163da59ffd8ecd836d09afcea1576";
    ...
    [Fact]
    public void VerifyBaselineFixture_10AutoAcceptedExhaustive()
    {
        var entries = LoadBaselineEntries();
        ...
        // 2. SHA: 78dd11fe
        AssertAutoAccepted(
            entriesBySha["78dd11fe3474f22ce753bc122bf6b9577a1b92b2a011c6a63256c772eb89e1b6"],
            expectedYear: 2015,
            expectedBasis: FinancialBasis.Consolidated,
            expectedKind: FinancialTargetKind.FinancialYearData,
            expectedEntityId: 5,
            expectedLineItem: "Revenue",
            expectedValue: 1384.73m,
            expectedPage: 11,
            expectedSheet: "Consolidated Financial Data",
            expectedRow: 46,
            expectedCol: 3,
            expectedHeader: "31 Mar, 2015",
            expectedRowLabel: "Net Revenue");
        ...
        // 7. SHA: 1348399f
        AssertAutoAccepted(
            entriesBySha["1348399f2f4cb708ac3e073f5b41a9be6ac29a70fe605a0d5f938c16eb7cf49d"],
            expectedYear: 2014,
            expectedBasis: FinancialBasis.Standalone,
            expectedKind: FinancialTargetKind.FinancialYearData,
            expectedEntityId: 1,
            expectedLineItem: "Revenue",
            expectedValue: 1447.53m,
            expectedPage: 2,

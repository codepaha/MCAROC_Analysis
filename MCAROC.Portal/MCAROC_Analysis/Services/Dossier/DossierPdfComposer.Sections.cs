...
public partial class DossierPdfComposer
{
    ...
    private void ComposeSection1(IContainer container) => container.Column(col =>
    {
        ...
        col.Item().Element(c => Lead(c,
            ...
            "Litigation. Every flag and its severity are generated by Cubictree's deterministic rule " +
            "engine; the narrative below each flag and the cross-section read are generated by CT AI, " +
            "validated against those same findings before publication (see Methodology note). Figures in ₹ Crore unless stated."));

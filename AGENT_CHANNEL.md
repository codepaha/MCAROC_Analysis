...
- **DONE** Pilot Deliverable 2 — Deterministic Charge-Link Pass (`feature/pilot-d2-charge-linking`):
  ...
  4. Committed baseline fixture `coastal_d2_baseline.json`: contains all 814 entries sorted strictly by `(OuterEntryFullPath, NestedEntryRelativePath)`. Configured `.gitattributes` for LF eol and independently computed LF SHA-256: `2C438F392A01251599799F2384073A29DE27D50D19C3515798F7D87113A6BC9A`.
